import type { SEOProps } from "$global/seo/Seo.svelte.types";
import type { ContentFulContentType } from "$types/contentful";
...
// SEO
export const SEO_DEFAULT: SEOProps = {
	siteName: ORG_NAME,
...
// Contentful
export const CONTENT_TYPES: ContentFulContentType[] = [
