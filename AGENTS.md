...
## Key Conventions
- `src/data/generated/**` is generated content output; update via `bun run content` instead of hand editing.
- `docs/**` and `*.md` changes are excluded from CI triggers in `.github/workflows/ci.yml`.
